// ==UserScript==
// @name           showCookiesGroup_Fx38.uc.xul
...
function moveCookiesGroup() {
  ...
  if (cookiesBox &&
    ...
    historyGroup.appendChild(CookiesGroup);
  ...
  if (document.createElement("cookiesGroup"))
    document.createElement("cookiesGroup").removeAttribute("hidden");
  let style = ' \
...
try {
  ...
  // in-content  
  document.getElementById("historyPane").addEventListener("paneload", moveCookiesGroup, false);
}

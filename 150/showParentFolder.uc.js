...
*/
    Services.console.logStringMessage("PlacesTreeView.prototype._getColumnType = function " + func.replace(/^function/, ''));
    Cu.evalInSandbox("PlacesTreeView.prototype._getColumnType = function " + func.replace(/^function/, ''), sb);
    ...
    */
    Services.console.logStringMessage("PlacesTreeView.prototype.getCellText = function " + func.replace(/^function/, ''));
    Cu.evalInSandbox("PlacesTreeView.prototype.getCellText = function " + func.replace(/^function/, ''), sb);
...
*/
    Cu.evalInSandbox("PlacesTreeView.prototype.cycleHeader = function " + func.replace(/^function/, ''), sb);

...
// @version        2024/03/11 19:00 fix progressbar
    ...
    init: function() {
      ...
      let menu = ref.parentNode.insertBefore(
        this.createElement("menuitem",
          [{attr: "id", value:"menu_openDownloadManager"},
      ...
      document.getElementById("menu_openDownloadManager").addEventListener("command", () => ucjs_downloadManager.openDownloadManager(true));
...
*/
      ...
      if (showProgressInTaskButton) {
        setTimeout(function() {
          try {
            let { docShell } = window.browsingContext.topChromeWindow;

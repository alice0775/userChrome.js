...
// @description    Web Panel のコマンドのバグパッチ 戻る/進む/再読込の他バグを修正
// @include        chrome://browser/content/web-panels.xul
// @compatibility  Firefox 38
// @author         Alice0775
// @version        2015/05/19 16:30 Firefox38
...
function mynsContextMenu(aXulMenu, aIsShift) {
  this.shouldDisplay = true;
  this.initMenu(aXulMenu, aIsShift);
}

// Prototype for nsContextMenu "class."
mynsContextMenu.prototype = {
  initMenu: function CM_initMenu(aXulMenu, aIsShift) {
    ...
    if (!aIsShift) {
      this.hasPageMenu = false; 
      /*PageMenu.maybeBuildAndAttachMenu(this.target, aXulMenu);*/
    }
...
contextMenu.setAttribute("onpopupshowing", "if (event.target != this)\
     return true;\
   gContextMenu = new mynsContextMenu(this, event.shiftKey);\

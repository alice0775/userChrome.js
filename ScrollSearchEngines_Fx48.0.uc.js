// ==UserScript==
// @name           ScrollSearchEngines_Fx48.0.uc.js
...
var scrollSearchEngines = {
  ...
  init: function() {
    ...
    if(this.searchMenu) {
      ...
      this.searchMenu.addEventListener("wheel", this, false);
  ...
  uninit: function() {
    ...
    if(this.searchMenu) {
      // enables to change search engine by mouse-wheel on context menu
      this.searchMenu.removeEventListener("wheel", this, false);
    }

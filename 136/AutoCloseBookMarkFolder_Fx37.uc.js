...
var acBookMarkTreeFolder = {
  ...
  init: function(){
    ...
    searchBookmarks = function(aSearchString) {
      searchBookmarks_org.apply(this, arguments);
  ...
  addToolbar: function(){
    ...
    toolbox.setAttribute("id", "acBookMarkTreeFolder-toolbox");
    ...
    closeAllButton.addEventListener("command", () => acBookMarkTreeFolder.closeAll());
    ...
    openAllButton.addEventListener("command", () => acBookMarkTreeFolder.openAll());
